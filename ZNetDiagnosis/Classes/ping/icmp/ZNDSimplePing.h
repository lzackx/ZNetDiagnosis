...
@protocol ZNDSimplePingDelegate;
...
@interface ZNDSimplePing : NSObject
...
@property (nonatomic, weak, readwrite, nullable) id<ZNDSimplePingDelegate> delegate;
...
@protocol ZNDSimplePingDelegate <NSObject>
...
- (void)simplePing:(ZNDSimplePing *)pinger didStartWithAddress:(NSData *)address;
 ...
 */
- (void)simplePing:(ZNDSimplePing *)pinger didFailWithError:(NSError *)error;
...
- (void)simplePing:(ZNDSimplePing *)pinger didSendPacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber;
 ...
 *  \param error Describes the failure.
 */
- (void)simplePing:(ZNDSimplePing *)pinger didFailToSendPacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber error:(NSError *)error;
 ...
 *  \param sequenceNumber The ICMP sequence number of that packet.
 */
- (void)simplePing:(ZNDSimplePing *)pinger didReceivePingResponsePacket:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber;
 ...
 *      follows that in the ICMP message but does not include any IP-level headers.
 */
- (void)simplePing:(ZNDSimplePing *)pinger didReceiveUnexpectedPacket:(NSData *)packet;
